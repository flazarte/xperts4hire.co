<?php
/** 
 * Template Name: Default Page 2
 */ 
get_header();
?>
<div class="intro-banner dark-overlay" data-background-image="<?php bloginfo('stylesheet_directory');?>/images/home-background-02.jpg">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6">
            <!-- Photo Box -->
            <a href="jobs-list-layout-1.html" class="photo-box small" data-background-image="<?php bloginfo('stylesheet_directory');?>/images/job-category-01.jpg">
        ...
        <div class="col-xl-3 col-md-6">
            <!-- Photo Box -->
            <a href="jobs-list-layout-full-page-map.html" class="photo-box small" data-background-image="<?php bloginfo('stylesheet_directory');?>/images/job-category-02.jpg">
                <div class="photo-box-content">
        ...
        <div class="col-xl-3 col-md-6">
            <!-- Photo Box -->
            <a href="jobs-grid-layout-full-page.html" class="photo-box small" data-background-image="<?php bloginfo('stylesheet_directory');?>/images/job-category-03.jpg">
                <div class="photo-box-content">
        ...
        <div class="col-xl-3 col-md-6">
            <!-- Photo Box -->
            <a href="jobs-list-layout-2.html" class="photo-box small" data-background-image="<?php bloginfo('stylesheet_directory');?>/images/job-category-04.jpg">
                <div class="photo-box-content">
        ...
        <div class="col-xl-3 col-md-6">
            <!-- Photo Box -->
            <a href="jobs-list-layout-1.html" class="photo-box small" data-background-image="<?php bloginfo('stylesheet_directory');?>/images/job-category-05.jpg">
                <div class="photo-box-content">
        ...
        <div class="col-xl-3 col-md-6">
            <!-- Photo Box -->
            <a href="jobs-list-layout-full-page-map.html" class="photo-box small" data-background-image="<?php bloginfo('stylesheet_directory');?>/images/job-category-06.jpg">
                <div class="photo-box-content">
        ...
        <div class="col-xl-3 col-md-6">
            <!-- Photo Box -->
            <a href="jobs-grid-layout-full-page.html" class="photo-box small" data-background-image="<?php bloginfo('stylesheet_directory');?>/images/job-category-07.jpg">
                <div class="photo-box-content">
        ...
        <div class="col-xl-3 col-md-6">
            <!-- Photo Box -->
            <a href="jobs-list-layout-2.html" class="photo-box small" data-background-image="<?php bloginfo('stylesheet_directory');?>/images/job-category-08.jpg">
                <div class="photo-box-content">
...
<div class="fullwidth-carousel-container margin-top-20">
    <div class="testimonial-carousel testimonials">
        ...
        <div class="fw-carousel-review">
            <div class="testimonial-box">
                <div class="testimonial-avatar">
                    <img src="<?php bloginfo('stylesheet_directory');?>/images/user-avatar-small-02.jpg" alt="">
                </div>
        ...
        <div class="fw-carousel-review">
            <div class="testimonial-box">
                <div class="testimonial-avatar">
                    <img src="<?php bloginfo('stylesheet_directory');?>/images/user-avatar-small-01.jpg" alt="">
                </div>
                <div class="testimonial-author">
                    <h4>Tom Smith</h4>
                     <span>Freelancer</span>
        ...
        <div class="fw-carousel-review">
            <div class="testimonial-box">
                <div class="testimonial-avatar">
                    <img src="<?php bloginfo('stylesheet_directory');?>/images/user-avatar-placeholder.png" alt="">
                </div>
                <div class="testimonial-author">
        ...
        <div class="fw-carousel-review">
            <div class="testimonial-box">
                <div class="testimonial-avatar">
                    <img src="<?php bloginfo('stylesheet_directory');?>/images/user-avatar-small-03.jpg" alt="">
                </div>
                <div class="testimonial-author">
