				...
				<div class="listings-container compact-list-layout margin-top-35">
					...
					<a href="single-job-page.html" class="job-listing with-apply-button">
						...
						<div class="job-listing-details">
							...
							<div class="job-listing-company-logo">
								<img src="<?php bloginfo('stylesheet_directory');?>/images/company-logo-01.png" alt="">
							</div>
					...
					<a href="single-job-page.html" class="job-listing with-apply-button">
						...
						<div class="job-listing-details">
							...
							<!-- Logo -->
							<div class="job-listing-company-logo">
								<img src="<?php bloginfo('stylesheet_directory');?>/images/company-logo-05.png" alt="">
							</div>
					...
					<a href="single-job-page.html" class="job-listing with-apply-button">
						...
						<div class="job-listing-details">
							...
							<!-- Logo -->
							<div class="job-listing-company-logo">
								<img src="<?php bloginfo('stylesheet_directory');?>/images/company-logo-02.png" alt="">
							</div>
					...
					<a href="single-job-page.html" class="job-listing with-apply-button">
						...
						<div class="job-listing-details">
							...
							<!-- Logo -->
							<div class="job-listing-company-logo">
								<img src="<?php bloginfo('stylesheet_directory');?>/images/company-logo-03.png" alt="">
							</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-1.html" class="photo-box" data-background-image="<?php bloginfo('stylesheet_directory');?>/images/featured-city-01.jpg">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-full-page-map.html" class="photo-box" data-background-image="<?php bloginfo('stylesheet_directory');?>/images/featured-city-02.jpg">
					<div class="photo-box-content">
						<h3>New York</h3>
						<span>645 Jobs</span>
					</div>
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-grid-layout-full-page.html" class="photo-box" data-background-image="<?php bloginfo('stylesheet_directory');?>/images/featured-city-03.jpg">
					<div class="photo-box-content">
						<h3>Los Angeles</h3>
						<span>832 Jobs</span>
					</div>
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-2.html" class="photo-box" data-background-image="<?php bloginfo('stylesheet_directory');?>/images/featured-city-04.jpg">
					<div class="photo-box-content">
						<h3>Miami</h3>
						<span>513 Jobs</span>
					</div>
				...
				<div class="default-slick-carousel freelancers-container freelancers-grid-layout">
						...
						<div class="freelancer-overview">
							<div class="freelancer-overview-inner">
								...
								<div class="freelancer-avatar">
									...
									<a href="single-freelancer-profile.html"><img src="<?php bloginfo('stylesheet_directory');?>/images/user-avatar-big-01.jpg" alt=""></a>
								</div>

								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="single-freelancer-profile.html">Tom Smith <img class="flag" src="<?php bloginfo('stylesheet_directory');?>/images/flags/gb.svg" alt="" title="United Kingdom" data-tippy-placement="top"></a></h4>
					...
					<div class="freelancer">
						...
						<div class="freelancer-overview">
							<div class="freelancer-overview-inner">
								...
								<div class="freelancer-avatar">
									<div class="verified-badge"></div>
									<a href="single-freelancer-profile.html"><img src="<?php bloginfo('stylesheet_directory');?>/images/user-avatar-big-02.jpg" alt=""></a>
								</div>

								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="#">David Peterson <img class="flag" src="<?php bloginfo('stylesheet_directory');?>/images/flags/de.svg" alt="" title="Germany" data-tippy-placement="top"></a></h4>
					...
					<div class="freelancer">
						...
						<div class="freelancer-overview">
							<div class="freelancer-overview-inner">
								...
								<!-- Avatar -->
								<div class="freelancer-avatar">
									<a href="single-freelancer-profile.html"><img src="<?php bloginfo('stylesheet_directory');?>/images/user-avatar-placeholder.png" alt=""></a>
								</div>

								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="#">Marcin Kowalski <img class="flag" src="<?php bloginfo('stylesheet_directory');?>/images/flags/pl.svg" alt="" title="Poland" data-tippy-placement="top"></a></h4>
					...
					<div class="freelancer">
						...
						<div class="freelancer-overview">
								...
								<div class="freelancer-avatar">
									<div class="verified-badge"></div>
									<a href="single-freelancer-profile.html"><img src="<?php bloginfo('stylesheet_directory');?>/images/user-avatar-big-03.jpg" alt=""></a>
								</div>

								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="#">Sindy Forest <img class="flag" src="<?php bloginfo('stylesheet_directory');?>/images/flags/au.svg" alt="" title="Australia" data-tippy-placement="top"></a></h4>
					...
					<div class="freelancer">
						...
						<div class="freelancer-overview">
								...
								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="#">Sebastiano Piccio <img class="flag" src="<?php bloginfo('stylesheet_directory');?>/images/flags/it.svg" alt="" title="Italy" data-tippy-placement="top"></a></h4>
					...
					<div class="freelancer">
						...
						<div class="freelancer-overview">
								...
								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="#">Gabriel Lagueux <img class="flag" src="<?php bloginfo('stylesheet_directory');?>/images/flags/fr.svg" alt="" title="France" data-tippy-placement="top"></a></h4>
