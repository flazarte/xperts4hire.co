...
//    error_log('$is_blocked:'. $email_domain);
    ...
    if($is_blocked){
        $errors->add( 'blocked_domain', sprintf(__( "This %s domain is not allowed! 1", 'user-verification' ), '<strong>'.$email_domain.'</strong>') );
    }
...
//    error_log('$is_allowed:'. $email_domain);
    ...
    if(!$is_allowed){
        $errors->add( 'blocked_domain', sprintf(__( "This %s domain is not allowed! 2", 'user-verification' ), '<strong>'.$email_domain.'</strong>') );
    }
