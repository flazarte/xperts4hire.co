...
* Feature - Added layout attribute in shortcode to manage the layout independently.
* Tweak - Removed "Job Listing Views" section from the Appearance settings.
* Fix - Fixed the label capitalization issue for applicant details.
* Fix - Fixed SJB Shortcode Inserter issue in Gutenberg Classic Editor Block
* Dev Note - Removed 'sjb_job_listing_view' hook after introducing layout attribute in shortcode & block.
...
= 2.8.0 =
Added Gutenberg block for SJB listing.